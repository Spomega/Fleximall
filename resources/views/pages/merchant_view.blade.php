                ...
                <div class="top-nav-inner">
                    <div class="nav-header">
                        ...
                        <a href="index.html" class="brand">
                            <i class="fa fa-database"></i><span class="brand-name">FLEXIMALL MERCHANT</span>
                        </a>
                    </div>
